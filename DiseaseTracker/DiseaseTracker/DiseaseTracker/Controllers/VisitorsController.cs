...
namespace DiseaseTracker.Controllers
{
    public class VisitorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Ip,LastVisit,TotalVisits")] Visitor visitor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Ip,LastVisit,TotalVisits")] Visitor visitor)
        {
            if (ModelState.IsValid)
            {
